...
public class WelcomePageObject extends MainPageObject
{
    private static final String
            ...
            STEP_LEARN_ABOUT_DATA_COLLECTED_LINK = "id:Learn more about data collected",
            NEXT_LINK = "id:Next",
    ...
    {
        this.waitForElementPresent(STEP_LEARN_ABOUT_DATA_COLLECTED_LINK), "Cannot find 'Learn more about data collected' link", 10);
    }
