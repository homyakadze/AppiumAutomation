...
public class WelcomePageObject extends MainPageObject
{
    private static final String
            ...
            STEP_LEARN_ABOUT_DATA_COLLECTED_LINK = "Learn more about data collected",
            NEXT_LINK = "Next",
    ...
    {
        this.waitForElementPresent(By.id(STEP_LEARN_ABOUT_DATA_COLLECTED_LINK), "Cannot find 'Learn more about data collected' link", 10);
    }

    public void clickNextButton()
    {
        this.waitForElementAndClick(By.id(NEXT_LINK), "Cannot find 'Next' link", 10);
    }

    public void clickGetStartedButton()
    {
        this.waitForElementAndClick(By.id(GET_STARTED_BUTTON), "Cannot find 'Get started' link", 10);
    }
}
