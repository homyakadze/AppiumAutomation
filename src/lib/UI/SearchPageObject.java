...
public class SearchPageObject extends MainPageObject{
    ...
    public void initSearchInput()
    {
        ...
        this.waitForElementPresent(By.xpath(SEARCH_INIT_ELEMENT), "Cannot find search input after clicking searc init element");
    }

    public void waitForCancelButtonToAppear()
    {
        this.waitForElementPresent(By.id(SEATCH_CANCEL_BUTTON),"Cannot find search cancel button", 5);
    }
